...
class Data(models.Model):
    ...
    meal_item = ArrayField(models.CharField(max_length=100, blank=True), default=list, blank=True)  # Allow empty array
    ...
    activity_item = ArrayField(models.CharField(max_length=100, blank=True), default=list, blank=True)  # Allow empty array
